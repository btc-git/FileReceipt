### * Program under development. Independently validate all FileReceipt results. *
...
Click [here](https://github.com/btc-git/FileReceipt#download-for-most-users) to download the latest version (8/23/2023).
