### * Program under development. Independently validate all FileReceipt results. (8/11/2023) *
...
Download the latest release on GitHub [here](https://github.com/btc-git/FileReceipt/raw/main/FileReceipt.exe). (8/11/2023)
